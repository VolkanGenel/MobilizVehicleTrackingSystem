...
public enum EErrorType {
    ...
    VEHICLE_DUPLICATE(4210,"Böyle bir araç mevcut",HttpStatus.BAD_REQUEST),
    VEHICLE_NOT_FOUND(4211,"Böyle bir araç bulunamadı",HttpStatus.NOT_FOUND),
    VEHICLE_NOT_CREATED(4212,"Kullanıcı oluşturulamadı",HttpStatus.BAD_REQUEST),

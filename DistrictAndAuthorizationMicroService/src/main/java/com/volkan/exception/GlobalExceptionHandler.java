...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DistrictAndAuthorizationManagerException.class)
    public ResponseEntity<ErrorMessage> handleManagerException(DistrictAndAuthorizationManagerException ex){
